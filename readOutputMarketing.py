##Analysis of Marketing resume evaluations
...
df_normal = df_normal[df_normal["job_applied"] == "Marketing"]
df_exp_req = df_exp_req[df_exp_req["job_applied"] == "Marketing"]
...
print("Chi-square for normal prompt of recommendation and race[Marketing Job]:", chi2.__round__(3))
print("P-val for normal prompt of recommendation and race:[Marketing Job]", p.__round__(3))
...
print("Chi-square for experience required prompt of recommendation and race[Marketing Job]:", chi2.__round__(3))
print("P-val for experience required prompt of recommendation and race:[Marketing Job]", p.__round__(3))
...
print("Chi-square for normal prompt of recommendation and experience level[Marketing Job]:", chi2.__round__(3))
print("P-val for normal prompt of recommendation and experience level:[Marketing Job]", p.__round__(3))


table = pd.crosstab(df_exp_req ["experience_level"], df_exp_req ["recommendation"])
chi2, p, dof, expected = chi2_contingency(table)

print("Chi-square for experience required prompt of recommendation and experience level[Marketing Job]:", chi2.__round__(3))
print("P-val for experience required prompt of recommendation and experience level:[Marketing Job]", p.__round__(3))
...
print("Chi-square for normal prompt of recommendation and institution[Marketing Job]:", chi2.__round__(3))
print("P-val for normal prompt of recommendation and institution:[Marketing Job]", p.__round__(3))


table = pd.crosstab(df_exp_req ["institution"], df_exp_req ["recommendation"])
chi2, p, dof, expected = chi2_contingency(table)

print("Chi-square for experience required prompt of recommendation and institution:[Marketing Job]", chi2.__round__(3))
print("P-val for experience required prompt of recommendation and institution:[Marketing Job]", p.__round__(3))
...
print("Chi-square for normal prompt of recommendation and degree[Marketing Job]:", chi2.__round__(3))
print("P-val for normal prompt of recommendation and degree:[Marketing Job]", p.__round__(3))


table = pd.crosstab(df_exp_req ["degree"], df_exp_req ["recommendation"])
chi2, p, dof, expected = chi2_contingency(table)

print("Chi-square for experience required prompt of recommendation and degree[Marketing Job]:", chi2.__round__(3))
print("P-val for experience required prompt of recommendation and degree:[Marketing Job]", p.__round__(3))
...
print("Chi-square for normal prompt of recommendation and skills[Marketing Job]:", chi2.__round__(3))
print("P-val for normal prompt of recommendation and skills:[Marketing Job]", p.__round__(3))
...
print("Chi-square for experience required prompt of recommendation and skills[Marketing Job]:", chi2.__round__(3))
print("P-val for experience required prompt of recommendation and skills:[Marketing Job]", p.__round__(3))
...
print("Chi-square for normal prompt of recommendation and sex[Marketing Job]:", chi2.__round__(3))
print("P-val for normal prompt of recommendation and sex[Marketing Job]:", p.__round__(3))
...
print("Chi-square for experience required prompt of recommendation and sex[Marketing Job]:", chi2.__round__(3))
print("P-val for experience required prompt of recommendation and sex[Marketing Job]:", p.__round__(3))
...
# P-val for normal prompt of recommendation and race: 0.963
# P-val for experience required prompt of recommendation and race: 0.883
...
# P-val for experience required prompt of recommendation and institution: 0(seattle university has higher recommendation scores)

# P-val for normal prompt of recommendation and degree: 0(masters vs bachelors: 0.445)
# P-val for experience required prompt of recommendation and degree: 0 #experience required prompt made a difference!

# P-val for normal prompt of recommendation and skills: 0(only signficant result was microsoft office suite being less preferred than other skills)
# P-val for experience required prompt of recommendation and skills: 0 (microsoft office suite was least preferred skill)
