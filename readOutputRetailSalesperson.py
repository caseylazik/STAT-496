##Analysis of Retail Salesperson resume evaluations
...
df_normal = df_normal[df_normal["job_applied"] == "Retail Salesperson"]
df_exp_req = df_exp_req[df_exp_req["job_applied"] == "Retail Salesperson"]
...
print("Chi-square for normal prompt of recommendation and race[Retail Salesperson Job]:", chi2.__round__(3))
print("P-val for normal prompt of recommendation and race:[Retail Salesperson Job]", p.__round__(3))
...
print("Chi-square for experience required prompt of recommendation and race[Retail Salesperson Job]:", chi2.__round__(3))
print("P-val for experience required prompt of recommendation and race:[Retail Salesperson Job]", p.__round__(3))
...
print("Chi-square for normal prompt of recommendation and experience level[Retail Salesperson Job]:", chi2.__round__(3))
print("P-val for normal prompt of recommendation and experience level:[Retail Salesperson Job]", p.__round__(3))


table = pd.crosstab(df_exp_req ["experience_level"], df_exp_req ["recommendation"])
chi2, p, dof, expected = chi2_contingency(table)

print("Chi-square for experience required prompt of recommendation and experience level[Retail Salesperson Job]:", chi2.__round__(3))
print("P-val for experience required prompt of recommendation and experience level:[Retail Salesperson Job]", p.__round__(3))
...
print("Chi-square for normal prompt of recommendation and institution[Retail Salesperson Job]:", chi2.__round__(3))
print("P-val for normal prompt of recommendation and institution:[Retail Salesperson Job]", p.__round__(3))


table = pd.crosstab(df_exp_req ["institution"], df_exp_req ["recommendation"])
chi2, p, dof, expected = chi2_contingency(table)

print("Chi-square for experience required prompt of recommendation and institution:[Retail Salesperson Job]", chi2.__round__(3))
print("P-val for experience required prompt of recommendation and institution:[Retail Salesperson Job]", p.__round__(3))
...
print("Chi-square for normal prompt of recommendation and degree[Retail Salesperson Job]:", chi2.__round__(3))
print("P-val for normal prompt of recommendation and degree:[Retail Salesperson Job]", p.__round__(3))
...
print("Chi-square for experience required prompt of recommendation and degree[Retail Salesperson Job]:", chi2.__round__(3))
print("P-val for experience required prompt of recommendation and degree:[Retail Salesperson Job]", p.__round__(3))
...
print("Chi-square for normal prompt of recommendation and skills[Retail Salesperson Job]:", chi2.__round__(3))
print("P-val for normal prompt of recommendation and skills:[Retail Salesperson Job]", p.__round__(3))
...
print("Chi-square for experience required prompt of recommendation and skills[Retail Salesperson Job]:", chi2.__round__(3))
print("P-val for experience required prompt of recommendation and skills:[Retail Salesperson Job]", p.__round__(3))
...
print("Chi-square for normal prompt of recommendation and sex[Retail Salesperson Job]:", chi2.__round__(3))
print("P-val for normal prompt of recommendation and sex[Retail Salesperson Job]:", p.__round__(3))
...
print("Chi-square for experience required prompt of recommendation and sex[Retail Salesperson Job]:", chi2.__round__(3))
print("P-val for experience required prompt of recommendation and sex[Retail Salesperson Job]:", p.__round__(3))
...
# P-val for normal prompt of recommendation and race: 0.937
# P-val for experience required prompt of recommendation and race: 0.933 

# P-val for normal prompt of recommendation and sex: 0.855
# P-val for experience required prompt of recommendation and sex: 0.725
...
# P-val for normal prompt of recommendation and institution: 0(uw has higher recommendation scores)
# P-val for experience required prompt of recommendation and institution: 0.102(uw has higher recommendation scores)

# P-val for normal prompt of recommendation and degree: 0(bachelors appears preferable to masters)
# P-val for experience required prompt of recommendation and degree: 0(masters vs bachelors: 0.112, bachelors slightly preffered)

# P-val for normal prompt of recommendation and skills: 0.121(Customer Service seems to be the most preferable skill) 

# P-val for experience required prompt of recommendation and skills: 0 (Product Knowledge seems to be the LEAST preferable skill)
