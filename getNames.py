...
gender_by_name = pd.read_csv("C:\\Users\\casey\\Downloads\\name_gender_dataset.csv")  #https://archive.ics.uci.edu/dataset/591/gender+by+name
first_name_race_probs = pd.read_csv("C:\\Users\\casey\\Downloads\\first_nameRaceProbs.csv") #https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/SGKW0K
last_names = pd.read_csv("C:\\Users\\casey\\Downloads\\last_raceNameProbs.csv") #https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/SGKW0K
...
def sample_names(df, n=3):
    return df.sample(n=n, replace=False)['name'].tolist()
...
print(names) # Automatically link to generate resumes
