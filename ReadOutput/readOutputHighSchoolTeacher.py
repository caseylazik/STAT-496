##Analysis of High School Teacher resume evaluations
...
df_normal = df_normal[df_normal["job_applied"] == "High School Teacher"]
df_exp_req = df_exp_req[df_exp_req["job_applied"] == "High School Teacher"]
...
print("Chi-square for normal prompt of recommendation and race[High School Teacher Job]:", chi2.__round__(3))
print("P-val for normal prompt of recommendation and race:[High School Teacher Job]", p.__round__(3))
...
print("Chi-square for experience required prompt of recommendation and race[High School Teacher Job]:", chi2.__round__(3))
print("P-val for experience required prompt of recommendation and race:[High School Teacher Job]", p.__round__(3))
...
print("Chi-square for normal prompt of recommendation and experience level[High School Teacher Job]:", chi2.__round__(3))
print("P-val for normal prompt of recommendation and experience level:[High School Teacher Job]", p.__round__(3))


table = pd.crosstab(df_exp_req ["experience_level"], df_exp_req ["recommendation"])
chi2, p, dof, expected = chi2_contingency(table)

print("Chi-square for experience required prompt of recommendation and experience level[High School Teacher Job]:", chi2.__round__(3))
print("P-val for experience required prompt of recommendation and experience level:[High School Teacher Job]", p.__round__(3))
...
print("Chi-square for normal prompt of recommendation and institution[High School Teacher Job]:", chi2.__round__(3))
print("P-val for normal prompt of recommendation and institution:[High School Teacher Job]", p.__round__(3))


table = pd.crosstab(df_exp_req ["institution"], df_exp_req ["recommendation"])
chi2, p, dof, expected = chi2_contingency(table)

print("Chi-square for experience required prompt of recommendation and institution:[High School Teacher Job]", chi2.__round__(3))
print("P-val for experience required prompt of recommendation and institution:[High School Teacher Job]", p.__round__(3))
...
print("Chi-square for normal prompt of recommendation and degree[High School Teacher Job]:", chi2.__round__(3))
print("P-val for normal prompt of recommendation and degree:[High School Teacher Job]", p.__round__(3))


table = pd.crosstab(df_exp_req ["degree"], df_exp_req ["recommendation"])
chi2, p, dof, expected = chi2_contingency(table)

print("Chi-square for experience required prompt of recommendation and degree[High School Teacher Job]:", chi2.__round__(3))
print("P-val for experience required prompt of recommendation and degree:[High School Teacher Job]", p.__round__(3))
...
print("Chi-square for normal prompt of recommendation and skills[High School Teacher Job]:", chi2.__round__(3))
print("P-val for normal prompt of recommendation and skills:[High School Teacher Job]", p.__round__(3))
...
print("Chi-square for experience required prompt of recommendation and skills[High School Teacher Job]:", chi2.__round__(3))
print("P-val for experience required prompt of recommendation and skills:[High School Teacher Job]", p.__round__(3))
...
print("Chi-square for normal prompt of recommendation and sex[High School Teacher Job]:", chi2.__round__(3))
print("P-val for normal prompt of recommendation and sex[High School Teacher Job]:", p.__round__(3))
...
print("Chi-square for experience required prompt of recommendation and sex[High School Teacher Job]:", chi2.__round__(3))
print("P-val for experience required prompt of recommendation and sex[High School Teacher Job]:", p.__round__(3))
...
# P-val for normal prompt of recommendation and race: 0.1
# P-val for experience required prompt of recommendation and race: 0.861 

# P-val for normal prompt of recommendation and sex: 0.985
# P-val for experience required prompt of recommendation and sex: 0.691
...
# P-val for normal prompt of recommendation and skills: 0(First Aid Certification is the most preferable skill)
# P-val for experience required prompt of recommendation and skills: 0.215
