##Analysis of Software Engineer resume evaluations
...
df_normal = df_normal[df_normal["job_applied"] == "Software Engineer"]
df_exp_req = df_exp_req[df_exp_req["job_applied"] == "Software Engineer"]
...
print("Chi-square for normal prompt of recommendation and race[Software Engineer Job]:", chi2.__round__(3))
print("P-val for normal prompt of recommendation and race:[Software Engineer Job]", p.__round__(3))
...
print("Chi-square for experience required prompt of recommendation and race[Software Engineer Job]:", chi2.__round__(3))
print("P-val for experience required prompt of recommendation and race:[Software Engineer Job]", p.__round__(3))
...
print("Chi-square for normal prompt of recommendation and experience level[Software Engineer Job]:", chi2.__round__(3))
print("P-val for normal prompt of recommendation and experience level:[Software Engineer Job]", p.__round__(3))


table = pd.crosstab(df_exp_req ["experience_level"], df_exp_req ["recommendation"])
chi2, p, dof, expected = chi2_contingency(table)

print("Chi-square for experience required prompt of recommendation and experience level[Software Engineer Job]:", chi2.__round__(3))
print("P-val for experience required prompt of recommendation and experience level:[Software Engineer Job]", p.__round__(3))
...
print("Chi-square for normal prompt of recommendation and institution[Software Engineer Job]:", chi2.__round__(3))
print("P-val for normal prompt of recommendation and institution:[Software Engineer Job]", p.__round__(3))


table = pd.crosstab(df_exp_req ["institution"], df_exp_req ["recommendation"])
chi2, p, dof, expected = chi2_contingency(table)

print("Chi-square for experience required prompt of recommendation and institution:[Software Engineer Job]", chi2.__round__(3))
print("P-val for experience required prompt of recommendation and institution:[Software Engineer Job]", p.__round__(3))
...
print("Chi-square for normal prompt of recommendation and degree[Software Engineer Job]:", chi2.__round__(3))
print("P-val for normal prompt of recommendation and degree:[Software Engineer Job]", p.__round__(3))


table = pd.crosstab(df_exp_req ["degree"], df_exp_req ["recommendation"])
chi2, p, dof, expected = chi2_contingency(table)

print("Chi-square for experience required prompt of recommendation and degree[Software Engineer Job]:", chi2.__round__(3))
print("P-val for experience required prompt of recommendation and degree:[Software Engineer Job]", p.__round__(3))
...
print("Chi-square for normal prompt of recommendation and skills[Software Engineer Job]:", chi2.__round__(3))
print("P-val for normal prompt of recommendation and skills:[Software Engineer Job]", p.__round__(3))
...
print("Chi-square for experience required prompt of recommendation and skills[Software Engineer Job]:", chi2.__round__(3))
print("P-val for experience required prompt of recommendation and skills:[Software Engineer Job]", p.__round__(3))
...
print("Chi-square for normal prompt of recommendation and sex[Software Engineer Job]:", chi2.__round__(3))
print("P-val for normal prompt of recommendation and sex[Software Engineer Job]:", p.__round__(3))
...
print("Chi-square for experience required prompt of recommendation and sex[Software Engineer Job]:", chi2.__round__(3))
print("P-val for experience required prompt of recommendation and sex[Software Engineer Job]:", p.__round__(3))
...
# P-val for normal prompt of recommendation and race: 0.865
# P-val for experience required prompt of recommendation and race: 0.356 

# P-val for normal prompt of recommendation and sex: 0.781
# P-val for experience required prompt of recommendation and sex: 0.46
...
# P-val for experience required prompt of recommendation and institution: 0(uw has higher recommendation scores)

# P-val for normal prompt of recommendation and degree: 0(bachelors vs no degree: 0.163)
# P-val for experience required prompt of recommendation and degree: 0(bachelors vs no degree: 0.006)

# P-val for normal prompt of recommendation and skills: 0(unclear which skill was preferable, Python and SQL was worse than other skills)
# P-val for experience required prompt of recommendation and skills: 0 (unclear which skill was preferable)
